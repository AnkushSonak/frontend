    ...
    return(
        <div className="forgot-form-container">
            ...
            <p className="forgot-form-text color-gray">
                Make sure your new password is eight character or more. Try including numbers, letters, and punctuation marks for a <span className='link color-blue'>strong password</span>.
            </p>
            <p className="forgot-form-text color-gray">
