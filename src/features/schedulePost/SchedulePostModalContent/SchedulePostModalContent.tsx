        ...
        <div className="schedule-post-modal-content">
            <div className="schedule-post-modal-content-top">
                <div className="schedule-post-modal-content-scheduled-info">
                    ...
                    Will send on INJECT DATE HERE at INJECT TIME HERE
                </div>
                <p className="schedule-post-modal-content-label">Date</p>
                <div className="schedule-post-modal-content-date-group">
                    <ValidatedDateSelector name='Month' valid={true} dropDown={getMonths} dispatcher={() => {}} />
                    <ValidatedDateSelector name='Day' valid={true} dropDown={getDays} dispatcher={() => {}} />
                    <ValidatedDateSelector name='Year' valid={true} dropDown={getYears} dispatcher={() => {}} />
                ...
                <div className="schedule-post-modal-content-time-group">
                    ...
                    <ValidatedDateSelector name='Hour' valid={true} dropDown={() => {return [<option></option>]}} dispatcher={() => {}} />
                    <ValidatedDateSelector name='Minute' valid={true} dropDown={() => {return [<option></option>]}} dispatcher={() => {}} />
                    <ValidatedDateSelector name='AM/PM' valid={true} dropDown={() => {return [<option></option>]}} dispatcher={() => {}} />
                </div>
