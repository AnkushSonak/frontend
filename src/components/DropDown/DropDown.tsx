    ...
    return(
        <div className="dropdown-container">
            <StyledInputBox active={active} valid={true}>
                ...
                <select onChange={changeValue} onFocus={toggleSelect} onBlur={toggleSelect} value={data ? data : defaultValue} className='validated-input-value validated-date-selector'>
                    {content()}
                </select>
            </StyledInputBox>
        </div>
